...
namespace SmartMathExtended
{
    public class Math
    {
        ...
        */
        ...
        public static Vector3 RoundVectorToGrid (Vector3 vector, float distance)
        {
            Vector3 v = vector;
            v.x = Mathf.Round(v.x / distance) * distance;
            v.y = Mathf.Round(v.y / distance) * distance;
            v.z = Mathf.Round(v.z / distance) * distance;
            return v;
        }
        public static Vector3 RoundVectorToGrid (Vector2 vector, float distance)
        {
            Vector2 v = vector;
            v.x = Mathf.Round(v.x / distance) * distance;
            v.y = Mathf.Round(v.y / distance) * distance;
